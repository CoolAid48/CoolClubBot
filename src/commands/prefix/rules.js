  ...
  return new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        '',
        '*Violation of the rules can result in any punishment from a short mute to a permanent ban. Follow the rules, and you\'ll be fine. Have fun exploring the server and welcome to the Club!*',
      ].join('\n')
    )
